...
void ENVIADATA(){ //--------------------->>>>>>>>> FUNCION ENVIADATA
...
// String mostra4="6-enviaSTATUS";// FRASE enviaSTATUS desde arduino        
   ...
   delay (100);
                    ...
                    Serial.print(T1);//          sens nro= 11//tempArranque -->  temp de inicio          --carga inicial para desarrollo       
                          Serial.print(F(" "));// separador palabra
                    Serial.print(T2);//          sens nro= 12//tempSET -->  temp a llegar en rampa ---carga inicial para desarrollo             
                        Serial.print(F(" "));// separador palabra
                    ...
                    //Serial.print(nEvent);//      sens nro= 14// contador de eventos--->> REVISAR no llega, no se usa en ardu
                     Serial.print(321);//      sens nro= 14// contador de eventos--->> REVISAR no llega, no se usa en ardu
                          Serial.print(F(" "));// separador palabra
                   Serial.print(s3);//          sens nro= 15 int s3 = 50; 
                    //Serial.print(1.75);//          arduino no decodifica float --enviar *100 y dividir  o poner un parse 
                          Serial.print(F(" "));// separador palabra
                   Serial.print(s4);//          sens nro= 16 int s4 = 50;  --->> se recibe como % rango 0 a 100  <<---
                   //Serial.print(4.25);//          sens nro= 16 envia bien
                          Serial.print(F(" "));// separador palabra
                   //Serial.print(s5/100); //        sens nro= 17  asi llega bien 
                   Serial.print(s5); //        sens nro= 17 float s5 DECODIFICA DE 0 A 255 
                   //Serial.print(-100.23);
                          Serial.print(F(" "));// separador palabra
